...
| 4| owner_type | Type of the equipment that own network interfaces | `instance`, `transithub_attachment`, `inter_project_peering`, `inter_region_peering`, `colocation_gateway` or `loadbalancer` | |
...
### Important notes for using Flow Log assigned to a transit hub connection
